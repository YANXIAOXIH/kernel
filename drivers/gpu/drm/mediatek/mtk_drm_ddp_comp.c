...
static const struct mtk_ddp_comp_match mtk_ddp_matches[DDP_COMPONENT_ID_MAX] = {
	...
	[DDP_COMPONENT_DP_INTF0]	= { MTK_DP_INTF,	0, NULL },
	[DDP_COMPONENT_DP_INTF1]	= { MTK_DP_INTF,	1, NULL },
	[DDP_COMPONENT_DPI0]	= { MTK_DPI,		0, &ddp_dpi },
	[DDP_COMPONENT_DPI1]	= { MTK_DPI,		1, &ddp_dpi },
	[DDP_COMPONENT_DSC0]	= { MTK_DISP_DSC,	0, NULL },
	[DDP_COMPONENT_DSC1]	= { MTK_DISP_DSC,	1, NULL },
	[DDP_COMPONENT_DSI0]	= { MTK_DSI,		0, &ddp_dsi },
	[DDP_COMPONENT_DSI1]	= { MTK_DSI,		1, &ddp_dsi },
	[DDP_COMPONENT_DSI2]	= { MTK_DSI,		2, &ddp_dsi },
	[DDP_COMPONENT_DSI3]	= { MTK_DSI,		3, &ddp_dsi },
	[DDP_COMPONENT_GAMMA]	= { MTK_DISP_GAMMA,	0, &ddp_gamma },
	[DDP_COMPONENT_MERGE0]	= { MTK_DISP_MERGE,	0, NULL },
	[DDP_COMPONENT_MERGE1]	= { MTK_DISP_MERGE,	1, NULL },
	[DDP_COMPONENT_MERGE2]	= { MTK_DISP_MERGE,	2, NULL },
	[DDP_COMPONENT_MERGE3]	= { MTK_DISP_MERGE,	3, NULL },
	[DDP_COMPONENT_MERGE4]	= { MTK_DISP_MERGE,	4, NULL },
	[DDP_COMPONENT_MERGE5]	= { MTK_DISP_MERGE,	5, NULL },
