...
#define VDEC_POWER_CLOCK_IMPROVEMENT 0
...
#define MTK_VDEC_PORT_NUM	40
#define MTK_VENC_PORT_NUM	64
#define MTK_MAX_METADATA_NUM    8

extern struct platform_device *vdec_pm_dev[MTK_VDEC_MAX_LARB_COUNT];
extern struct platform_device *venc_pm_dev[MTK_VENC_MAX_LARB_COUNT];
...
struct venc_frm_buf {
	...
	bool has_dynamic_ctl;
	struct dma_buf *dynamic_ctl_dma;
	struct dma_buf_attachment *dynamic_ctl_att;
	struct sg_table *dynamic_ctl_sgt;
	dma_addr_t dynamic_ctl_addr;
	unsigned int dynamic_ctl_fd;
};
 ...
 **/
	...
	atomic_t atomic_dvfs_on[MAX_VDEC_HW];
	bool vdec_power_always_on;
#endif
};
...
#define V4L2_BUF_FLAG_QP_META			0x10000000
#define V4L2_BUF_FLAG_HAS_META			0x4000000
#define V4L2_BUF_FLAG_DYNAMIC_CTRL_META		0x20000000
