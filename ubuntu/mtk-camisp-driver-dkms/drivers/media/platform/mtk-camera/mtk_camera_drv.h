...
#define MTK_CAMERA_DEV_NAME	"mtk-v4l2-camera"
#define MTK_CAMERA_DRV_NAME	"mtk-camera"
...
#define MTK_CAMERA_RAW_PREVIEW_MIN_BUFFERS 7
#define MTK_CAMERA_RAW_CAPTURE_MIN_BUFFERS 1
#define MTK_CAMERA_YUV_MIN_BUFFERS 3
