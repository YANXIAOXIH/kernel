 ...
 *
 ****************************************************************************/
#ifndef _AR0830AP1302MIPI_SENSOR_H
#define _AR0830AP1302MIPI_SENSOR_H

#include "ar0830ap1302_control.h"

#define AR0830AP1302_SLAVE_SENSOR_COUNT		(1)			/* number of slave sensors actually connected */
#define AR0830AP1302_SLAVE_SENSOR_NUM_MAX		(2)
#define AR0830AP1302_REG_CHIP_ID				(0x0000)
#define AR0830AP1302_CHIP_ID					(0x0265)
enum IMGSENSOR_MODE {
	IMGSENSOR_MODE_INIT,
...
struct imgsensor_info_struct {
	...
	// Add for AR0430+AR0830AP1302
	//record slave sensor id defined in Kd_imgsensor.h
	kal_uint32 slave_sensor_id;
};

/* SENSOR READ/WRITE ID */
//#define IMGSENSOR_WRITE_ID_1 (0x78)
//#define IMGSENSOR_READ_ID_1  (0x79)
//#define IMGSENSOR_WRITE_ID_2 (0x7a)
//#define IMGSENSOR_READ_ID_2  (0x7b)
